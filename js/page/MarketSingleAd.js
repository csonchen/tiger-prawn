/**
 * Created by chensheng on 16/6/20.
 */
'use strict';
(function (ns) {
    ...
    var rate = 10000;
    ns.MarketSingleAd = tp.component.BaseList.extend({
        $context: null,
        $ranger: null,
        autoFetch: true,
        events: {
        ...
        initialize: function (options) {
            ...
            tp.component.BaseList.prototype.initialize.call(this, _.extend(options, {
                autoFetch: false,
                container: 'tbody',
                reset: true
            }));
            ...
            if (document.body.clientWidth >= 768 && this.$el.closest('modal').length === 0 && typeahead) {
                this.header = new tp.component.table.FixedHeader({
                    target: this
                });
            }
        ...
        render: function () {
            tp.component.BaseList.prototype.render.call(this);
        ...
        collection_errorHandler: function (collection, response) {
            this.$('.waiting td').html(tp.component.Manager.createErrorMsg(response));
        },
        collection_syncHandler: function () {
            tp.component.BaseList.prototype.collection_syncHandler.call(this);
        ...
        sync: function () {
            ...
            cpas = JSON.stringify(cpas);
            tp.service.Manager.call(tp.API + 'market/' + this.ad_id, cpas, {
                context: this,
...
}(Nervenet.createNameSpace('tp.page.ad')));